...
Rectangle 
{
	...
	*/
	...
	Item
	{
		...
		{
			console.log("setSoundFunction() Got parameter:", path)//only for debugging purpose...
		...
		{
			console.log("playSoundFunction()")//only for debugging purpose...
		...
		{
			console.log("setAndPlaySoundFunction()")//only for debugging purpose...
			playSoundEffect.source = path;
			txtInputFile.visible = true;
			txtInputFile.text = "Selected file: " + path;			
			playSoundEffect.play();			
		...
		{
			console.log("playMovieFunction()")//only for debugging purpose...
			//video.play(); 
			mediaplayer.play();
			return true;
		}				
