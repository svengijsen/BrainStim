...
//Copyright (C) 2015  Sven Gijsen and Michael Luehrs
//
...
void TriggerTimer::startTimer(double dMSec)//Do not change the function name without changing the below!
{
	...
	{
		//if (
		QMetaObject::invokeMethod(this, "startTimer", Qt::QueuedConnection, Q_ARG(double, dMSec));// == false)//Cannot be a DirectConnection !!
		//{
		//	int a = 9;
		//}
	}
